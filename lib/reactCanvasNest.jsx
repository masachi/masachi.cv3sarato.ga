...
class ReactCanvasNest extends Component {
  ...
  setSize = (fn) => {
    ...
    const contentHeight = document.getElementById('content')?.getBoundingClientRect()?.height || 0
    const footerHeight = document.getElementById('footer')?.getBoundingClientRect()?.height || 0
    ...
    this.setState(
      {
        outDivWidth: parent.clientWidth,
        outDivHeight: headerHeight + contentHeight + footerHeight,
      },
      typeof fn === 'function' ? fn : null
    )
  }
